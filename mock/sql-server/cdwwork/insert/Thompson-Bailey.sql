...
--          Service history: Gulf War (1990-1991), Iraq (2003-2010)
...
--  10. Labs (~50 representative results, key trends)
-- =====================================================
-- Last Updated: 2026-02-08
-- Author: med-z1 development team
-- Related: docs/spec/thompson-twins-patient-reqs.md (v3.1)
--          docs/spec/thompson-twins-implementation-plan.md (v2.0)
-- =====================================================
...
PRINT '=====================================================';
PRINT '====    Thompson Twins: Bailey Thompson          ====';
PRINT '====    PatientSID 2001, ICN200001               ====';
PRINT '=====================================================';
GO
...
(9001, 2001, 'PtIEN2001', 516, 1, 'PHONE NUMBER [HOME]', '727-555-2001', NULL, GETDATE()),
(9002, 2001, 'PtIEN2001', 516, 2, 'CELLULAR PHONE NUMBER', '727-555-2002', NULL, GETDATE()),
-- Washington phone numbers (2025-present)
(9003, 2001, 'PtIEN2001', 687, 3, 'PHONE NUMBER [HOME]', '509-555-2001', NULL, GETDATE()),
(9004, 2001, 'PtIEN2001', 687, 4, 'CELLULAR PHONE NUMBER', '509-555-2002', NULL, GETDATE());
GO
...
VALUES
-- Primary: VA (100% service-connected disability)
(9001, 2001, 'PtIEN2001', 'PtInsIEN2001', 508, 5, 'RETIRED', '2010-06-15', '2010-06-15'),
-- Secondary: Medicare (age 65+, enrolled 2028, but represented here for completeness)
(9002, 2001, 'PtIEN2001', 'PtInsIEN2001', 516, 1, 'RETIRED', '2028-04-15', '2028-04-15');
GO
...
VALUES
-- PTSD (70%)
(9001, 2001, 'PtIEN2001', 516, 11001, 'Y', 70, 'N', 'N', 'N', 'N', NULL, NULL, 'N', 'Y'),
-- Chronic Back Pain (40%, combined with PTSD)
(9002, 2001, 'PtIEN2001', 516, 11001, 'Y', 40, 'N', 'N', 'N', 'N', NULL, NULL, 'N', 'Y'),
-- Tinnitus (10%)
(9003, 2001, 'PtIEN2001', 516, 11001, 'Y', 100, 'N', 'N', 'N', 'N', NULL, NULL, 'N', 'Y'),
-- Traumatic Brain Injury (10%)
(9004, 2001, 'PtIEN2001', 516, 11001, 'Y', 100, 'N', 'N', 'N', 'N', NULL, NULL, 'N', 'Y');
GO

PRINT '  Bailey Thompson demographics details inserted (Address, Phone, Insurance, Disability)';
GO

PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Demographics Complete     ====';
PRINT '====  PatientSID 2001 created successfully       ====';
PRINT '=====================================================';
GO
...
PRINT '';
PRINT 'Inserting Bailey Thompson vitals (2010-2025, quarterly readings)...';
GO
...
VALUES
    ...
    (9001, 2001, 5, '2010-06-16 09:30:00', '2010-06-16 09:35:00', '70', 70, NULL, NULL, 177.8,
        ...
        1001, 'N', 'N', 516),
    (9002, 2001, 6, '2010-06-16 09:30:00', '2010-06-16 09:35:00', '185', 185, NULL, NULL, 84.0,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (9003, 2001, 1, '2010-06-16 09:30:00', '2010-06-16 09:35:00', '125/78', NULL, 125, 78, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (9004, 2001, 3, '2010-06-16 09:30:00', '2010-06-16 09:35:00', '72', 72, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (9005, 2001, 2, '2010-06-16 09:30:00', '2010-06-16 09:35:00', '98.4', 98.4, NULL, NULL, 36.9,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (
00', '5', 5, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1003, 'N', 'N', 516),

    -- 2024-09-15 (Bay Pines FL - last visit before relocation)
    (9216, 2001, 6, '2024-09-15 10:00:00', '2024-09-15 10:03:00', '220', 220, NULL, NULL, 99.8,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (9217, 2001, 1, '2024-09-15 10:00:00', '2024-09-15 10:03:00', '135/84', NULL, 135, 84, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (9218, 2001, 9, '2024-09-15 10:00:00', '2024-09-15 10:03:00', '122', 122, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),
    (9219, 2001, 7, '2024-09-15 10:00:00', '2024-09-15 10:03:00', '6', 6, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1001, 'N', 'N', 516),

    -- 2024-12-10 (Bay Pines FL - final visit before move)
    (9220, 2001, 6, '2024-12-10 14:20:00', '2024-12-10 14:23:00', '218', 218, NULL, NULL, 98.9,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1002, 'N', 'N', 516),
    (9221, 2001, 1, '2024-12-10 14:20:00', '2024-12-10 14:23:00', '136/82', NULL, 136, 82, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1002, 'N', 'N', 516),
    (9222, 2001, 9, '2024-12-10 14:20:00', '2024-12-10 14:23:00', '120', 120, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1002, 'N', 'N', 516),
    (9223, 2001, 7, '2024-12-10 14:20:00', '2024-12-10 14:23:00', '5', 5, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 516 AND LocationType = 'CLINIC'),
        1002, 'N', 'N', 516),

    -- 2025-02-15 (Walla Walla WA - first visit after relocation)
    (9224, 2001, 6, '2025-02-15 11:00:00', '2025-02-15 11:03:00', '220', 220, NULL, NULL, 99.8,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1001, 'N', 'N', 687),
    (9225, 2001, 1, '2025-02-15 11:00:00', '2025-02-15 11:03:00', '138/85', NULL, 138, 85, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1001, 'N', 'N', 687),
    (9226, 2001, 9, '2025-02-15 11:00:00', '2025-02-15 11:03:00', '118', 118, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1001, 'N', 'N', 687),
    (9227, 2001, 7, '2025-02-15 11:00:00', '2025-02-15 11:03:00', '6', 6, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1001, 'N', 'N', 687),

    -- 2025-05-20 (Walla Walla WA - current)
    (9228, 2001, 6, '2025-05-20 09:15:00', '2025-05-20 09:18:00', '222', 222, NULL, NULL, 100.7,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1002, 'N', 'N', 687),
    (9229, 2001, 1, '2025-05-20 09:15:00', '2025-05-20 09:18:00', '135/84', NULL, 135, 84, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1002, 'N', 'N', 687),
    (9230, 2001, 9, '2025-05-20 09:15:00', '2025-05-20 09:18:00', '120', 120, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1002, 'N', 'N', 687),
    (9231, 2001, 7, '2025-05-20 09:15:00', '2025-05-20 09:18:00', '5', 5, NULL, NULL, NULL,
        (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n = 687 AND LocationType = 'CLINIC' ORDER BY LocationSID),
        1002, 'N', 'N', 687);
GO
...
PRINT '  Bailey Thompson vitals inserted (231 readings, 2010-2025)';
...
PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Section 3 (Vitals) Complete';
...
PRINT '';
PRINT 'Inserting Bailey Thompson allergies...';
GO
...
VALUES
    ...
    (9002, 2001, 7, 3, 'MORPHINE SULFATE',
...
PRINT '  Bailey Thompson allergies inserted (2 allergies)';
GO
...
PRINT '  Bailey Thompson allergy reactions inserted (3 reactions)';
GO

PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Section 4 (Allergies) Complete';
...
PRINT '';
PRINT 'Inserting Bailey Thompson medications (2010-2025, 45 total)...';
GO
...
-- Bailey Thompson medications (Sta3n 516 Bay Pines FL, 2010-2024)
...
(8001, 'RxIEN8001', 516, 2001, 'PtIEN2001', 10036, 'DrugIEN10036', 20024,
 ...
 '2025-01-15 10:00:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),

-- 2. Gabapentin 1200mg TID (neuropathic pain) - using 800mg caps
(8002, 'RxIEN8002', 516, 2001, 'PtIEN2001', 10076, 'DrugIEN10076', 20067,
 'GABAPENTIN', 'GABAPENTIN 800MG CAP', '2025-001-8002',
 ...
 '2025-01-15 10:05:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', NULL, 'N', 'Y', 'Y'),

-- 3. Metformin 1000mg BID (diabetes)
(8003, 'RxIEN8003', 516, 2001, 'PtIEN2001', 10027, 'DrugIEN10027', 20001,
 'METFORMIN HCL', 'METFORMIN HCL 1000MG TAB', '2025-001-8003',
...
(8004, 'RxIEN8004', 516, 2001, 'PtIEN2001', 10029, 'DrugIEN10029', 20004,
 'LISINOPRIL', 'LISINOPRIL 20MG TAB', '2025-001-8004',
...
(8005, 'RxIEN8005', 516, 2001, 'PtIEN2001', 10011, 'DrugIEN10011', 20014,
 'ATORVASTATIN CALCIUM', 'ATORVASTATIN CALCIUM 40MG TAB', '2025-001-8005',
...
(8006, 'RxIEN8006', 516, 2001, 'PtIEN2001', 10033, 'DrugIEN10033', 20017,
 'ASPIRIN', 'ASPIRIN 81MG TAB EC', '2025-001-8006',
...
(8007, 'RxIEN8007', 516, 2001, 'PtIEN2001', 10090, 'DrugIEN10090', 20081,
 'OMEPRAZOLE', 'OMEPRAZOLE 40MG CAP DR', '2025-001-8007',
...
(8008, 'RxIEN8008', 516, 2001, 'PtIEN2001', 10098, 'DrugIEN10098', 20089,
 'TRAZODONE HCL', 'TRAZODONE HCL 50MG TAB', '2025-001-8008',
 ...
 '2025-01-15 10:35:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),

-- 9. Prazosin 2mg nightly (PTSD nightmares - using 2mg x2-3 for 5mg dose)
(8009, 'RxIEN8009', 516, 2001, 'PtIEN2001', 10092, 'DrugIEN10092', 20083,
 'PRAZOSIN HCL', 'PRAZOSIN HCL 2MG CAP', '2025-001-8009',
 ...
 '2025-01-15 10:40:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),

-- 10. Acetaminophen 650mg Q6H PRN (pain)
(8010, 'RxIEN8010', 516, 2001, 'PtIEN2001', 10059, 'DrugIEN10059', 20050,
 'ACETAMINOPHEN', 'ACETAMINOPHEN 650MG TAB', '2025-001-8010',
 ...
 '2025-01-15 10:45:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', NULL, 'N', 'N', 'N'),

-- 11. Naproxen 500mg BID PRN (pain, inflammation)
(8011, 'RxIEN8011', 516, 2001, 'PtIEN2001', 10089, 'DrugIEN10089', 20080,
 'NAPROXEN SODIUM', 'NAPROXEN SODIUM 500MG TAB', '2025-001-8011',
 ...
 '2025-01-15 10:50:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', NULL, 'N', 'N', 'N'),

-- 12. Multivitamin daily (nutritional support)
(8012, 'RxIEN8012', 516, 2001, 'PtIEN2001', 10088, 'DrugIEN10088', 20079,
 'MULTIVITAMIN', 'MULTIVITAMIN TAB', '2025-001-8012',
...
(8013, 'RxIEN8013', 516, 2001, 'PtIEN2001', 10022, 'DrugIEN10022', 20033,
 ...
 '2010-06-20 14:00:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', 'C-II', 'Y', 'N', 'N'),

-- 14. Cyclobenzaprine 10mg (2010-2014, discontinued due to sedation)
(8014, 'RxIEN8014', 516, 2001, 'PtIEN2001', 10068, 'DrugIEN10068', 20059,
 ...
 '2010-07-15 10:30:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', NULL, 'N', 'N', 'N'),

-- 15. Ibuprofen 800mg (2010-2015, discontinued due to GI upset)
(8015, 'RxIEN8015', 516, 2001, 'PtIEN2001', 10079, 'DrugIEN10079', 20070,
...
(8016, 'RxIEN8016', 516, 2001, 'PtIEN2001', 10050, 'DrugIEN10050', 20025,
 ...
 '2011-04-15 11:00:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),

-- 17. Citalopram 20mg (2012-2013, second SSRI trial, limited benefit)
(8017, 'RxIEN8017', 516, 2001, 'PtIEN2001', 10051, 'DrugIEN10051', 20026,
 ...
 '2012-06-20 13:30:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),

-- 18. Escitalopram 10mg (2013-2015, third SSRI trial, switched to sertraline)
(8018, 'RxIEN8018', 516, 2001, 'PtIEN2001', 10070, 'DrugIEN10070', 20061,
 ...
 '2013-08-10 10:00:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),
...
(8019, 'RxIEN8019', 516, 2001, 'PtIEN2001', 10052, 'DrugIEN10052', 20034,
 ...
 '2013-06-25 14:30:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', 'C-II', 'Y', 'N', 'N'),

-- 20. Morphine ER 15mg (2014-2016, attempted long-acting opioid, discovered allergy)
(8020, 'RxIEN8020', 516, 2001, 'PtIEN2001', 10053, 'DrugIEN10053', 20035,
 ...
 '2014-03-20 11:00:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', 'C-II', 'Y', 'N', 'N'),

-- 21. Lorazepam 1mg (2015-2016, anxiety management, discontinued after suicide attempt)
(8021, 'RxIEN8021', 516, 2001, 'PtIEN2001', 10085, 'DrugIEN10085', 20076,
 ...
 '2015-01-15 09:30:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', 'C-IV', 'Y', 'N', 'N'),
...
(8022, 'RxIEN8022', 516, 2001, 'PtIEN2001', 10028, 'DrugIEN10028', 20004,
...
(8023, 'RxIEN8023', 516, 2001, 'PtIEN2001', 10026, 'DrugIEN10026', 20001,
...
(8024, 'RxIEN8024', 516, 2001, 'PtIEN2001', 10012, 'DrugIEN10012', 20015,
...
(8025, 'RxIEN8025', 516, 2001, 'PtIEN2001', 10094, 'DrugIEN10094', 20085,
 ...
 '2015-02-15 10:00:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),

-- 26. Sertraline 100mg (2017-2020, intermediate dose, escalated to 200mg)
(8026, 'RxIEN8026', 516, 2001, 'PtIEN2001', 10018, 'DrugIEN10018', 20024,
 ...
 '2017-02-20 11:00:00', NULL, NULL, 8004, 'ClinicIEN8004', 'MENTAL HEALTH CLINIC', NULL, 'N', 'Y', 'Y'),
...
(8027, 'RxIEN8027', 516, 2001, 'PtIEN2001', 10021, 'DrugIEN10021', 20032,
 ...
 '2017-01-15 10:00:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', 'C-IV', 'Y', 'N', 'N'),

-- 28. Gabapentin 300mg (2017-2020, initial dose for neuropathic pain, escalated to 1200mg TID)
(8028, 'RxIEN8028', 516, 2001, 'PtIEN2001', 10020, 'DrugIEN10020', 20031,
 ...
 '2017-03-20 09:00:00', NULL, NULL, 8003, 'ClinicIEN8003', 'PAIN MANAGEMENT CLINIC', NULL, 'N', 'Y', 'Y'),
...
(8029, 'RxIEN8029', 516, 2001, 'PtIEN2001', 10056, 'DrugIEN10056', 20040,
...
(8030, 'RxIEN8030', 516, 2001, 'PtIEN2001', 10054, 'DrugIEN10054', 20037,
...
(8031, 'RxIEN8031', 516, 2001, 'PtIEN2001', 10055, 'DrugIEN10055', 20039,
...
(8032, 'RxIEN8032', 516, 2001, 'PtIEN2001', 10093, 'DrugIEN10093', 20084,
...
PRINT '  Bailey Thompson medications inserted (32 medication records)';
...
PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Section 5 (Medications) Complete';
...
PRINT '';
PRINT 'Inserting Bailey Thompson encounters (2010-2025, 32 admissions)...';
GO

SET QUOTED_IDENTIFIER ON;
GO

-- Bailey Thompson Inpatient Encounters (Sta3n 516 Bay Pines FL)
...
PRINT '  Bailey Thompson encounters inserted (32 admissions, 2010-2025)';
...
PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Section 6 (Encounters) Complete';
...
-- =====================================================
-- Bailey Thompson: Representative subset of clinical notes
...
PRINT '  Creating representative subset of Bailey Thompson clinical notes';
...
VALUES (
    ...
    (SELECT TOP 1 InpatientSID FROM Inpat.Inpatient WHERE PatientSID = 2001 AND CAST(AdmitDateTime AS DATE) = '2016-09-12'),  -- Link to suicide attempt admission
    516,  -- Sta3n (Bay Pines)
    'BaileyTIU001'
);
...
VALUES (
    ...
    NULL,
    (SELECT TOP 1 InpatientSID FROM Inpat.Inpatient WHERE PatientSID = 2001 AND CAST(AdmitDateTime AS DATE) = '2016-09-12'),
    516,
    'BaileyTIU002'
);
...
VALUES (
    ...
    NULL,
    (SELECT TOP 1 InpatientSID FROM Inpat.Inpatient WHERE PatientSID = 2001 AND CAST(AdmitDateTime AS DATE) = '2022-11-10'),
    516,
    'BaileyTIU004'
);
...
VALUES (
    ...
    1002,
    (SELECT TOP 1 InpatientSID FROM Inpat.Inpatient WHERE PatientSID = 2001 AND CAST(AdmitDateTime AS DATE) = '2019-01-22'),
    516,
    'BaileyTIU005'
);
...
VALUES (
    ...
    1005,  -- Cardiologist
    NULL,
    (SELECT TOP 1 InpatientSID FROM Inpat.Inpatient WHERE PatientSID = 2001 AND CAST(AdmitDateTime AS DATE) = '2012-03-18'),
    516,
    'BaileyTIU006'
);
...
VALUES (
    ...
    1007,  -- Nephrologist
    NULL,
    (SELECT TOP 1 InpatientSID FROM Inpat.Inpatient WHERE PatientSID = 2001 AND CAST(AdmitDateTime AS DATE) = '2019-07-08'),
    516,
    'BaileyTIU008'
);
...
-- PRINT '  Bailey Thompson: 8 clinical note metadata records inserted';
-- GO
...
PRINT '  Bailey Thompson: Clinical note text inserted (2 detailed notes: Psychiatry Progress + Discharge Summary)';
GO

PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Section 7 (Clinical Notes) Complete';
...
-- =====================================================
-- Bailey Thompson: Final clinical domains
...
PRINT '  Completing final clinical domains for Bailey Thompson';
PRINT '=====================================================';
GO
...
(2001, 18, '2011-10-12 13:30:00', 'ANNUAL 2011', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2011', 1),
(2001, 18, '2012-10-10 14:15:00', 'ANNUAL 2012', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2012', 1),
(2001, 18, '2013-10-08 13:45:00', 'ANNUAL 2013', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2013', 1),
(2001, 18, '2014-10-14 14:00:00', 'ANNUAL 2014', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2014', 1),
(2001, 18, '2015-10-13 13:30:00', 'ANNUAL 2015', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2015', 1),
(2001, 18, '2016-10-11 14:00:00', 'ANNUAL 2016', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2016', 1),
(2001, 18, '2017-10-10 13:45:00', 'ANNUAL 2017', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2017', 1),
(2001, 18, '2018-10-09 14:15:00', 'ANNUAL 2018', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2018', 1),
(2001, 18, '2019-10-15 13:30:00', 'ANNUAL 2019', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2019', 1),
(2001, 18, '2020-10-12 14:00:00', 'ANNUAL 2020', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2020HD', 1),
(2001, 18, '2021-10-14 13:45:00', 'ANNUAL 2021', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2021HD', 1),
(2001, 18, '2022-10-11 14:15:00', 'ANNUAL 2022', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2022HD', 1),
(2001, 18, '2023-10-10 13:30:00', 'ANNUAL 2023', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2023HD', 1),
(2001, 18, '2024-10-08 14:00:00', 'ANNUAL 2024', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'FLU2024HD', 1),

-- COVID-19 vaccine series (6 doses: primary + boosters)
(2001, 24, '2021-01-15 10:00:00', '1 of 2', '0.3 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'COVID2021P1', 1),
(2001, 24, '2021-02-05 10:30:00', '2 of 2 COMPLETE', '0.3 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'COVID2021P2', 1),
(2001, 24, '2021-09-10 14:00:00', 'BOOSTER 1', '0.3 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'COVID2021PB1', 1),
(2001, 24, '2022-04-20 13:30:00', 'BOOSTER 2', '0.3 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'COVID2022PB2', 1),
(2001, 24, '2022-11-01 14:15:00', 'BIVALENT BOOSTER', '0.3 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'COVID2022BIVAL', 1),
(2001, 24, '2023-10-15 13:45:00', '2023 UPDATED BOOSTER', '0.3 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'COVID2023UPD', 1),

-- Pneumococcal vaccines (3 doses)
(2001, 11, '2013-06-01 10:00:00', 'SINGLE', '0.65 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'PPSV2013', 1),
(2001, 12, '2014-06-01 10:30:00', 'SINGLE', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'PCV2014', 1),
(2001, 11, '2018-06-01 09:45:00', 'BOOSTER', '0.65 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'PPSV2018', 1),

-- Tdap boosters (2 doses, 10-year interval)
(2001, 9, '2010-07-10 11:00:00', 'BOOSTER', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'TDAP2010', 1),
(2001, 9, '2020-08-15 10:30:00', 'BOOSTER', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'TDAP2020', 1),

-- Shingrix (Zoster) vaccine series (2 doses)
(2001, 16, '2023-03-15 14:00:00', '1 of 2', '0.5 ML', 'IM', 'L DELTOID', 'Mild arm soreness', 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'SHING2023-1', 1),
(2001, 16, '2023-09-20 13:30:00', '2 of 2 COMPLETE', '0.5 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'SHING2023-2', 1),

-- Hepatitis A series (2 doses)
(2001, 6, '2011-04-10 10:00:00', '1 of 2', '1.0 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'HEPA2011-1', 1),
(2001, 6, '2011-10-15 10:30:00', '2 of 2 COMPLETE', '1.0 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'HEPA2011-2', 1),

-- Hepatitis B series (3 doses)
(2001, 1, '2010-08-01 09:00:00', '1 of 3', '1.0 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'HEPB2010-1', 1),
(2001, 1, '2010-09-05 09:30:00', '2 of 3', '1.0 ML', 'IM', 'R DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'HEPB2010-2', 1),
(2001, 1, '2011-02-10 10:00:00', '3 of 3 COMPLETE', '1.0 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Outpatient' ORDER BY LocationSID), 516, 'HEPB2011-3', 1),

-- RSV vaccine (1 dose, age 60+, available 2024)
(2001, 29, '2024-09-15 14:30:00', 'SINGLE', '0.5 ML', 'IM', 'L DELTOID', NULL, 1001, 1002, (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Pharmacy' ORDER BY LocationSID), 516, 'RSV2024', 1);
GO

PRINT '    Bailey Thompson: 42 immunizations inserted (Flu x15, COVID x6, Pneumo x3, Tdap x2, Shingrix x2, Hep A/B, RSV)';
GO
...
-- =====================================================
PRINT '  Section 8.2: Problems/Diagnoses (18 problems, Charlson Comorbidity Index = 5)';
GO
...
(2001, 'ICN200001', 516, 'P2001-2', '90560007', 'Chronic lower back pain', 'M54.16', 'Radiculopathy, lumbar region', 'ACTIVE', '2004-04-12', '2010-06-20', '2024-09-15', NULL, 1006, 'Rodriguez, Juan MD', 'Pain Management', 'Y', 'N', 'Y', 'Rodriguez, Juan MD', '2010-06-20 13:00:00'),
(2001, 'ICN200001', 516, 'P2001-3', '127295002', 'Traumatic brain injury, sequelae', 'S06.9X9S', 'Unspecified intracranial injury with loss of consciousness of unspecified duration, sequela', 'ACTIVE', '2004-04-12', '2010-06-20', '2024-11-10', NULL, 1014, 'Nguyen, Linh MD', 'Neurology', 'Y', 'N', 'Y', 'Nguyen, Linh MD', '2010-06-20 15:45:00'),
(2001, 'ICN200001', 516, 'P2001-4', '15188001', 'Hearing loss, bilateral', 'H93.13', 'Tinnitus, bilateral', 'ACTIVE', '2004-04-12', '2011-05-10', '2024-08-25', NULL, 1020, 'Harper, Susan MD', 'Audiology', 'Y', 'N', 'Y', 'Harper, Susan MD', '2011-05-10 10:15:00'),
(2001, 'ICN200001', 516, 'P2001-5', '370143000', 'Major depressive disorder', 'F33.1', 'Major depressive disorder, recurrent, moderate', 'ACTIVE', '2011-02-10', '2011-02-15', '2024-10-15', NULL, 1001, 'Mitchell, Sarah MD', 'Mental Health', 'Y', 'N', 'Y', 'Mitchell, Sarah MD', '2011-02-15 14:45:00'),
(2001, 'ICN200001', 516, 'P2001-6', '38341003', 'Essential hypertension', 'I10', 'Essential (primary) hypertension', 'ACTIVE', '2012-03-18', '2012-03-20', '2025-01-05', NULL, 1005, 'Baker, Christine MD', 'Cardiology', 'N', 'N', 'Y', 'Baker, Christine MD', '2012-03-20 10:00:00'),
(2001, 'ICN200001', 516, 'P2001-7', '267036007', 'Dyslipidemia', 'E78.2', 'Mixed hyperlipidemia', 'ACTIVE', '2012-06-15', '2012-06-20', '2024-12-01', NULL, 1010, 'Taylor, Kevin MD', 'Primary Care', 'N', 'N', 'Y', 'Taylor, Kevin MD', '2012-06-20 09:30:00'),
(2001, 'ICN200001', 516, 'P2001-8', '44054006', 'Type 2 diabetes mellitus', 'E11.9', 'Type 2 diabetes mellitus without complications', 'ACTIVE', '2019-01-05', '2019-01-05', '2024-12-15', NULL, 1003, 'Patel, Raj MD', 'Endocrinology', 'N', 'N', 'Y', 'Patel, Raj MD', '2019-01-05 10:45:00'),
(2001, 'ICN200001', 516, 'P2001-9', '46177005', 'Chronic kidney disease', 'N18.3', 'Chronic kidney disease, stage 3a (moderate)', 'ACTIVE', '2019-07-08', '2019-07-10', '2025-01-08', NULL, 1007, 'Kim, Jennifer MD', 'Nephrology', 'N', 'N', 'Y', 'Kim, Jennifer MD', '2019-07-10 14:15:00'),
(2001, 'ICN200001', 516, 'P2001-10', '78275009', 'Obstructive sleep apnea', 'G47.33', 'Obstructive sleep apnea', 'ACTIVE', '2013-05-20', '2013-05-25', '2024-11-20', NULL, 1011, 'Garcia, Maria MD', 'Sleep Medicine', 'Y', 'N', 'Y', 'Garcia, Maria MD', '2013-05-25 11:00:00'),
(2001, 'ICN200001', 516, 'P2001-11', '235595009', 'Gastroesophageal reflux disease', 'K21.9', 'Gastro-esophageal reflux disease without esophagitis', 'ACTIVE', '2014-08-10', '2014-08-15', '2024-10-05', NULL, 1008, 'Martinez, Carlos MD', 'Gastroenterology', 'N', 'N', 'Y', 'Martinez, Carlos MD', '2014-08-15 10:00:00'),
(2001, 'ICN200001', 516, 'P2001-12', '414916001', 'Obesity', 'E66.9', 'Obesity, unspecified', 'ACTIVE', '2010-06-16', '2010-06-16', '2024-11-10', NULL, 1010, 'Taylor, Kevin MD', 'Primary Care', 'N', 'N', 'Y', 'Taylor, Kevin MD', '2010-06-16 10:15:00'),
(2001, 'ICN200001', 516, 'P2001-13', '53741008', 'Coronary atherosclerosis', 'I25.10', 'Atherosclerotic heart disease of native coronary artery without angina pectoris', 'ACTIVE', '2015-11-20', '2015-11-25', '2024-12-10', NULL, 1005, 'Baker, Christine MD', 'Cardiology', 'N', 'N', 'Y', 'Baker, Christine MD', '2015-11-25 11:30:00'),
(2001, 'ICN200001', 516, 'P2001-14', '239873007', 'Osteoarthritis', 'M19.90', 'Unspecified osteoarthritis, unspecified site', 'ACTIVE', '2010-01-01', '2010-08-15', '2024-10-20', NULL, 1009, 'Anderson, Lisa MD', 'Rheumatology', 'Y', 'N', 'Y', 'Anderson, Lisa MD', '2010-08-15 13:15:00'),
(2001, 'ICN200001', 516, 'P2001-15', '49436004', 'Atrial fibrillation', 'I48.91', 'Unspecified atrial fibrillation', 'ACTIVE', '2020-06-10', '2020-06-15', '2024-12-05', NULL, 1005, 'Baker, Christine MD', 'Cardiology', 'N', 'N', 'Y', 'Baker, Christine MD', '2020-06-15 10:15:00'),

-- Resolved/inactive conditions (3 total)
(2001, 'ICN200001', 516, 'P2001-16', '191889009', 'Alcohol use disorder', 'F10.20', 'Alcohol dependence, uncomplicated', 'INACTIVE', '2016-09-12', '2019-01-25', '2020-06-30', NULL, 1004, 'Brown, Michael PhD', 'Substance Use Disorder', 'N', 'N', 'N', 'Brown, Michael PhD', '2019-01-25 12:00:00'),
(2001, 'ICN200001', 516, 'P2001-17', '55822004', 'Hyperlipidemia', 'E78.5', 'Hyperlipidemia, unspecified', 'RESOLVED', '2010-06-16', '2010-06-16', '2012-06-20', '2012-06-20', 1010, 'Taylor, Kevin MD', 'Primary Care', 'N', 'N', 'N', 'Taylor, Kevin MD', '2010-06-16 09:45:00'),
(2001, 'ICN200001', 516, 'P2001-18', '233604007', 'Pneumonia', 'J18.9', 'Pneumonia, unspecified organism', 'RESOLVED', '2020-08-20', '2020-08-20', '2020-08-26', '2020-08-26', 1006, 'Miller, James MD', 'Emergency', 'N', 'Y', 'N', 'Miller, James MD', '2020-08-20 08:30:00');
GO

PRINT '    Bailey Thompson: 18 problems inserted (15 active chronic, 3 resolved/inactive)';
PRINT '    Charlson Comorbidity Index = 5 (DM without complications, CKD stage 3, CAD, Afib)';
GO
...
VALUES
(2001, 1, 'CH 20241205-2001', '140', 140.0, 'mmol/L', NULL, '135 - 145', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 2, 'CH 20241205-2001', '4.8', 4.8, 'mmol/L', NULL, '3.5 - 5.0', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 3, 'CH 20241205-2001', '102', 102.0, 'mmol/L', NULL, '98 - 107', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 4, 'CH 20241205-2001', '26', 26.0, 'mmol/L', NULL, '22 - 29', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 5, 'CH 20241205-2001', '22', 22.0, 'mg/dL', 'H', '7 - 20', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 6, 'CH 20241205-2001', '1.4', 1.4, 'mg/dL', 'H', '0.7 - 1.3', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 7, 'CH 20241205-2001', '142', 142.0, 'mg/dL', 'H', '70 - 100', '2024-12-05 08:00:00', '2024-12-05 10:15:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum');
GO

-- HbA1c results (diabetes monitoring, quarterly 2019-2024)
INSERT INTO [Chem].[LabChem] ([PatientSID], [LabTestSID], [AccessionNumber], [Result], [ResultNumeric], [ResultUnit], [AbnormalFlag], [RefRange], [CollectionDateTime], [ResultDateTime], [VistaPackage], [LocationSID], [Sta3n], [SpecimenType])
VALUES
(2001, 28, 'CH 20191005-A1C', '8.2', 8.2, '%', 'H', '4.0 - 5.6', '2019-01-05 08:00:00', '2019-01-05 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20190415-A1C', '7.8', 7.8, '%', 'H', '4.0 - 5.6', '2019-04-15 08:00:00', '2019-04-15 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20190715-A1C', '7.4', 7.4, '%', 'H', '4.0 - 5.6', '2019-07-15 08:00:00', '2019-07-15 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20200115-A1C', '7.0', 7.0, '%', 'H', '4.0 - 5.6', '2020-01-15 08:00:00', '2020-01-15 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20210615-A1C', '6.8', 6.8, '%', 'H', '4.0 - 5.6', '2021-06-15 08:00:00', '2021-06-15 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20220815-A1C', '6.9', 6.9, '%', 'H', '4.0 - 5.6', '2022-08-15 08:00:00', '2022-08-15 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20231120-A1C', '7.1', 7.1, '%', 'H', '4.0 - 5.6', '2023-11-20 08:00:00', '2023-11-20 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 28, 'CH 20241205-A1C', '6.8', 6.8, '%', 'H', '4.0 - 5.6', '2024-12-05 08:00:00', '2024-12-05 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood');
GO

-- Lipid panel (2024-06-15, annual)
INSERT INTO [Chem].[LabChem] ([PatientSID], [LabTestSID], [AccessionNumber], [Result], [ResultNumeric], [ResultUnit], [AbnormalFlag], [RefRange], [CollectionDateTime], [ResultDateTime], [VistaPackage], [LocationSID], [Sta3n], [SpecimenType])
VALUES
(2001, 23, 'CH 20240615-LIP', '195', 195.0, 'mg/dL', NULL, '0 - 200', '2024-06-15 08:00:00', '2024-06-15 11:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 24, 'CH 20240615-LIP', '108', 108.0, 'mg/dL', 'H', '0 - 100', '2024-06-15 08:00:00', '2024-06-15 11:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 25, 'CH 20240615-LIP', '42', 42.0, 'mg/dL', NULL, '40 - 60', '2024-06-15 08:00:00', '2024-06-15 11:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 26, 'CH 20240615-LIP', '225', 225.0, 'mg/dL', 'H', '0 - 150', '2024-06-15 08:00:00', '2024-06-15 11:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum'),
(2001, 27, 'CH 20240615-LIP', '45', 45.0, 'mg/dL', NULL, '5 - 40', '2024-06-15 08:00:00', '2024-06-15 11:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Serum');
GO

-- CBC Panel (2024-09-10)
INSERT INTO [Chem].[LabChem] ([PatientSID], [LabTestSID], [AccessionNumber], [Result], [ResultNumeric], [ResultUnit], [AbnormalFlag], [RefRange], [CollectionDateTime], [ResultDateTime], [VistaPackage], [LocationSID], [Sta3n], [SpecimenType])
VALUES
(2001, 8, 'CH 20240910-CBC', '6.8', 6.8, 'K/uL', NULL, '4.5 - 11.0', '2024-09-10 08:30:00', '2024-09-10 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 9, 'CH 20240910-CBC', '4.2', 4.2, 'M/uL', 'L', '4.5 - 5.9', '2024-09-10 08:30:00', '2024-09-10 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 10, 'CH 20240910-CBC', '13.0', 13.0, 'g/dL', 'L', '13.5 - 17.5', '2024-09-10 08:30:00', '2024-09-10 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 11, 'CH 20240910-CBC', '39', 39.0, '%', 'L', '40 - 52', '2024-09-10 08:30:00', '2024-09-10 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood'),
(2001, 12, 'CH 20240910-CBC', '230', 230.0, 'K/uL', NULL, '150 - 400', '2024-09-10 08:30:00', '2024-09-10 10:00:00', 'CH', (SELECT TOP 1 LocationSID FROM Dim.Location WHERE Sta3n=516 AND LocationType='Laboratory' ORDER BY LocationSID), 516, 'Whole Blood');
GO

PRINT '    Bailey Thompson: 40 lab results inserted (BMP, A1C, Lipids, CBC)';
...
(2001, 1, 'HIGH RISK FOR SUICIDE', 'I', 'N', 1, NULL,
...
(2001, NULL, 'OPIOID RISK TOOL', 'II', 'L', NULL, 100,
...
PRINT '';
PRINT '=====================================================';
PRINT '====  Bailey Thompson: Section 8 Complete';
...
PRINT '  UI testing: http://127.0.0.1:8000/patient/ICN200001';
PRINT '=====================================================';
GO
